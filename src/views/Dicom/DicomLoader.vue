...
onMounted(() => {
  ...
  createVTKPipeline('vtkContainer1', 'http://localhost:3000/files/Segmentation_Segment_5.stl', 0.3)
  ...
  <div>
    ...
    <div class="btn-wrap">
      <el-radio-group v-model="type" size="large">
        <el-radio label="单层" value="stack" />
        <el-radio label="MPR" value="volume" />
      </el-radio-group>
    </div>
    <div id="demo-wrap">
      <div v-show="type === 'stack'">
        <div id="element0" class="cornerstone-item" />
      </div>

      <div v-show="type === 'volume'">
        <div v-show="!fullWindowVis">
          <div id="element1" class="cornerstone-item">AX(横断面)</div>
          <div id="element2" class="cornerstone-item">LT(矢状面)</div>
          <div id="element3" class="cornerstone-item">AP(冠状面)</div>
          <div id="vtkContainer1" class="cornerstone-item">分割</div>
        </div>

        <!-- fullScreenRenderer -->
        <div class="vtk-fullContainer" id="vtkContainer2" v-show="fullWindowVis"></div>
      </div>
    </div>
    ...
    <div class="file-upload">
      ...
      <p v-if="uploadMessage" :class="{ success: isSuccess, error: !isSuccess }">
        {{ uploadMessage }}
      </p>
    </div>
  </div>
